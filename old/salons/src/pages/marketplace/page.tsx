...
const SalonMapView = lazy(() =>
  import("@/components/landing/salon-map-view").then((mod) => ({
    default: mod.SalonMapView,
  })),
);
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto relative z-10">
              ...
              >
                <h1 className="text-5xl sm:text-6xl font-bold mb-6 bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent">
                  Browse Top-Rated Salons
                </h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Discover and book appointments at the best salons near you.
                  Find your perfect salon experience in just a few clicks.
                </p>
              </motion.div>
            </div>
          </section>
          ...
          <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
            <div className="container mx-auto">
              ...
              {/* Filter Panel */}
              <FilterPanel onFilterChange={setFilters} isOpen={filterOpen} />
              ...
              {isLoading ? (
                ...
                <motion.div
                  ...
                  animate="visible"
                >
                  {filteredSalons.map((salon: SalonCard) => (
                    <motion.div
                      key={salon.id}
                    ...
                    >
                      <Link to={`/marketplace/salon/${salon.id}`}>
                        <motion.div
                          ...
                          initial="rest"
                          animate={
                            hoveredSalonId === salon.id ? "hover" : "rest"
                          }
                        >
                          <Card className="h-full overflow-hidden">
                            <CardContent className="p-0">
                              {/* Salon Image */}
                              <div className="relative h-40 sm:h-48 bg-linear-to-br from-purple-100 to-pink-100 rounded-t-lg overflow-hidden flex items-center justify-center">
                                {salon.logo_url ? (
                                  <img
                                    src={salon.logo_url}
                              ...
                              <div className="p-3 sm:p-4">
                                ...
                                {salon.starting_price && (
                                  <p className="text-xs sm:text-sm text-muted-foreground">
                                    From ₦
                                    {salon.starting_price.toLocaleString()}
                                  </p>
                                )}
                              </div>
                            </CardContent>
            ...
            <div className="container mx-auto max-w-3xl text-center">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-10">
                  Register your salon on Kenikool and start accepting bookings
