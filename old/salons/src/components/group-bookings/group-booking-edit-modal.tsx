...
import type { GroupBooking, GroupBookingMember } from "@/lib/api/types";
...
export function GroupBookingEditModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Group booking updated successfully!", "success");
      onClose();
    } catch (error: unknown) {
      const err = error as {
      ...
      const errorMessage =
        ...
        err.message ||
        "Failed to update group booking";
