    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          See what customers are saying about this service
        </p>
      </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                All reviews are from verified customers who have completed this
                service. Reviews are moderated to ensure quality and
                authenticity.
              </p>
            </div>
          </div>
