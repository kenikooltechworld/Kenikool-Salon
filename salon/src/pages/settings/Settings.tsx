...
export default function Settings() {
  ...
  // Load tenant data when it's fetched
  useEffect(() => {
    if (tenantData) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <button
          ...
          className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer text-left"
        >
          <h3 className="font-semibold text-foreground mb-1">General</h3>
        ...
        <button
          ...
          className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer text-left"
        >
          <h3 className="font-semibold text-foreground mb-1">System</h3>
          <p className="text-xs text-muted-foreground">Middleware & security</p>
        </button>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">Policies & rules</p>
        </button>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">SMS & payments</p>
        </button>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground">Rules & financial</p>
        </button>
        ...
        <button
          ...
          className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer text-left"
        >
          <h3 className="font-semibold text-foreground mb-1">Financial</h3>
          <p className="text-xs text-muted-foreground">Balance & refunds</p>
        </button>

        <button
          onClick={() => navigate("/settings/operational")}
          className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer text-left"
        >
          <h3 className="font-semibold text-foreground mb-1">Operational</h3>
          <p className="text-xs text-muted-foreground">Resources & inventory</p>
        </button>
        ...
        <button
          ...
          className="bg-card border border-border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer text-left"
        >
          <h3 className="font-semibold text-foreground mb-1">Billing</h3>
          <p className="text-xs text-muted-foreground">Plans & subscriptions</p>
        </button>
      </div>
